...
class InsertSectionForm extends MakeupForm
{
    public function create(): Form
    {
        ...
        $form->addGroup(T::trans('Insert new section into this page'));
        ...
        $form->addSubmit('submit', T::trans('Insert section'));
        ...
        if ($form->isSuccess()) {
            ...
            $this->flasher?->addSuccess(T::trans('Section inserted successfully.'));
